...
import EnquiriesTable from '@/app/ui/dashboard/enquiriesTable/enquiriesTable'

const EnquiriesPage = async ({ searchParams }) => {
  return (
      ...
      <div className="lg:pt-[86px] py-[70px lg:h-ful h-[83v flex  flex-col p- ">
        ...
        <div className=" w-full">
              <Suspense fallback={<Loading/>}>
                <EnquiriesTable searchParams={searchParams}/>
              </Suspense>
        </div>
      </div>
    </div>
